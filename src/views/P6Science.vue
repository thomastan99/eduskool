        ...
        <table id = "topicstable"> 
            ...
            <tr>
                ...
                <td> 
                    ...
                    <router-link to="/ready" tag="button" v-on:click="update('Chap1','Primary6Science')">Attempt </router-link>
            ...
            <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap2','Primary6Science')">Attempt </router-link>
                </td>
            ...
            <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap3','Primary6Science')">Attempt </router-link>
                </td>
                <td> 
             ...
             <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap4','Primary6Science')">Attempt </router-link>
                </td>
                <td> 
            ...
            <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap5','Primary6Science')">Attempt </router-link>
                </td>
                <td> 
