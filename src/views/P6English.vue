<template>
  ...
  <LeftPanel/>
     <div id="main">
        <div id="pageTitle"><h1> P6 English </h1></div>
        <table id = "topicstable"> 
            ...
            <tr>
                ...
                <td> 
                    ...
                    <router-link class="router-link" to="/ready" tag="button" v-on:click="update('Chap1','Primary6English')">Attempt </router-link>
            ...
            <tr>
                <td>
                    <h2 class="syllabus"> Chapter 2: Reading and Viewing </h2>
                </td>
                <td> 
                ...
                <td> 
                    <router-link class="router-link" to="/ready" tag="button" v-on:click="update('Chap2','Primary6English')">Attempt </router-link>
                </td>
            ...
            <tr>
                <td>
                    <h3 class="syllabus"> Chapter 3: Speaking </h3>
                </td>
                <td> 
                ...
                <td> 
                    <router-link class="router-link" to="/ready" tag="button" v-on:click="update('Chap3','Primary6English')">Attempt </router-link>
                </td>
                <td> 
             ...
             <tr>
                <td>
                    <h3 class="syllabus"> Chapter 4: Writing </h3>
                </td>
                <td> 
                ...
                <td> 
                    <router-link class="router-link" to="/ready" tag="button" v-on:click="update('Chap4','Primary6English')">Attempt </router-link>
                </td>
                <td> 
            ...
            <tr>
                <td>
                    <h3 class="syllabus"> Chapter 5: Grammar & Vocabulary </h3>
                </td>
                <td> 
                ...
                <td> 
                    <router-link class="router-link" to="/ready" tag="button" v-on:click="update('Chap5','Primary6English')">Attempt </router-link>
                </td>
                <td> 
...
export default {
  ...
  data(){
        return{
            ...
            chap5score: 0,
            currQuizChapter :"1",
            curQuizSubject :"Primary6English",
            wholeNumbers: false,
            fractions: false,
            decimals: false,
            percent: false,
