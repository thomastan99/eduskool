        ...
        <table id = "topicstable"> 
            ...
            <tr>
                ...
                <td> 
                    ...
                    <router-link to="/ready" tag="button" v-on:click="update('Chap1','Primary6English')">Attempt </router-link>
            ...
            <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap2','Primary6English')">Attempt </router-link>
                </td>
            ...
            <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap3','Primary6English')">Attempt </router-link>
                </td>
                <td> 
             ...
             <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap4','Primary6English')">Attempt </router-link>
                </td>
                <td> 
            ...
            <tr>
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap5','Primary6English')">Attempt </router-link>
                </td>
                <td> 
