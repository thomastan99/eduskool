<template>
  ...
  <LeftPanel/>
     <div id="main">
        <div id="pageTitle"><h1> P5 English </h1></div>
        <table id = "topicstable"> 
            ...
            <tr>
                <td> 
                    <h3 class="syllabus"> Chapter 1: Situational Writing </h3>
                </td>
                <td> 
            ...
            <tr>
                <td>
                    <h2 class="syllabus"> Chapter 2: Continuous Writing </h2>
                </td>
                <td> 
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap2','Primary5English')">Attempt </router-link>
                </td>
            ...
            <tr>
                <td>
                    <h3 class="syllabus"> Chapter 3: Language and Grammar </h3>
                </td>
                <td> 
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap3','Primary5English')">Attempt </router-link>
                </td>
                <td> 
             ...
             <tr>
                <td>
                    <h3 class="syllabus"> Chapter 4: Comprehension </h3>
                </td>
                <td> 
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap4','Primary5English')">Attempt </router-link>
                </td>
                <td> 
            ...
            <tr>
                <td>
                    <h3 class="syllabus"> Chapter 5: Oral Communication </h3>
                </td>
                <td> 
                ...
                <td> 
                    <router-link to="/ready" tag="button" v-on:click="update('Chap5','Primary5English')">Attempt </router-link>
                </td>
                <td> 
